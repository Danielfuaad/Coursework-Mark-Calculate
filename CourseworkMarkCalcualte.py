...
class App(Tk):
    ...
    def addLabAssessment(self):
        Label(self, text = "Lab Assessment",font = self.headerFont).grid(row=3,column =1)
        Label(self,text = "25%",font = self.headerFont).grid(row=3,column=3)
    ...
    def addLabTest(self):
        Label(self, text = "Lab Test",font = self.headerFont).grid(row=7,column =1)
        Label(self,text = "20%",font = self.headerFont).grid(row=7,column=3)
        ...
        self.txtLabTest2.grid(row = 9, column = 1)
        self.txtLabTest2.insert(0, "")
        Label(self,text = "10%").grid(row=9,column=2)

    def addMiniProject(self):
        Label(self, text = "Mini Project",font = self.headerFont).grid(row=10,column =1)
        Label(self,text = "25%",font = self.headerFont).grid(row=10,column=3)
        ...
        self.txtProduct.grid(row = 12, column = 1)
        self.txtProduct.insert(0, "")
        Label(self,text = "15%").grid(row=12,column=2)
    
    def FinalAssessment(self):
        Label(self, text = "Final Assessment",font = self.headerFont).grid(row = 13, column = 1)
        ...
        Label(self,text = "20%").grid(row=14,column=2)

    def addOutput(self):
        self.btnCalc = Button(self, text = "calculate grade")
        self.btnCalc.grid(row = 15, column = 1)
        self.btnCalc["command"] = self.calculate


        Label(self, text = "Overall Percent").grid(row = 17, column = 0)
